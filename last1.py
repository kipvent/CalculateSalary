...
class SalaryCalculator(QWidget):
    ...
    def initUI(self):
        ...
        self.background.setPixmap(QPixmap("relax_background.jpg"))
        ...
        self.salary_input.setFont(QFont("Helvetica", 9))
    ...
    def resizeEvent(self, event):
        ...
        self.header_white.setGeometry(35, 10, self.width()  // 3, 30)
        self.header_black.setGeometry(self.header_white.x() + self.header_white.width() + 15, 10, self.width() // 5, 30)
        self.minimize_button.setGeometry(self.width() - 60, 10, 20, 20)
        self.close_button.setGeometry(self.width() - 30, 10, 20, 20)

        self.salary_input.setGeometry(50, 50, self.width() // 4, 30)
        self.start_time_box.setGeometry(self.width() // 3 + 30, 50, 60, 30)
        self.end_time_box.setGeometry(self.width() // 3 + 110, 50, 60, 30)

        self.update_button.setGeometry(50, 100, self.width() // 4, 30)
        self.daily_label.setGeometry(50, 150, self.width() - 80, 30)
        self.monthly_label.setGeometry(50, 200, self.width() - 80, 30)

        self.prev_button.setGeometry(self.width() // 2 - 80, 100, 30, 30)
        self.play_button.setGeometry(self.width() // 2 - 40, 100, 30, 30)
        self.next_button.setGeometry(self.width() // 2, 100, 30, 30)
        self.volume_slider.setGeometry(self.width() // 2 + 50, 100, 100, 30)
        self.thank_button.setGeometry(self.width() - 50, self.height() - 50, 50, 50)
    ...
    def show_thank_dialog(self):
        ...
        thank_dialog.setGeometry(200, 250, 300, 200)
