...
class SalaryCalculator(QWidget):
    ...
    def initUI(self):
        ...
        self.header_black.setGeometry(260, 0, 100, 30)
        ...
        self.start_time_box.setGeometry(300, 30, 65, 30)  # Чуть уменьшена ширина
        ...
        self.end_time_label.setGeometry(380, 30, 50, 30)
        ...
        self.end_time_box.setGeometry(410, 30, 65, 30)  # Чуть уменьшена ширина
        ...
        self.daily_label = QLabel("Заработано за сегодня: 5000.00 рублей", self)
        ...
        self.next_button.setGeometry(360, 80, 30, 30)
        self.next_button.setStyleSheet("border: none;")

        # Ползунок громкости
        self.volume_slider = QSlider(Qt.Horizontal, self)
        self.volume_slider.setGeometry(400, 80, 150, 30)
